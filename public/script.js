...
// we use relative URLs (same-origin requests)
// This works for both development and production automatically!
const API_BASE_URL = ''; // Empty string = same origin (relative URLs)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('🔌 Frontend & Backend: Same-origin (unified deployment)');
    console.log(`📡 API Endpoint: ${window.location.origin}/api/contact`);
